...
export { GIT_DIFF_TAB_PREFIX, GIT_TAB_PREFIX, LAUNCHER_TAB_PREFIX, SETTINGS_TAB_ID, TERMINAL_TAB_PREFIX, gitDiffTab, gitTab, isGitDiffTab, isGitTab, isLauncherTab, isSettingsTab, isNodeTab, isTerminalTab, launcherTab, settingsTab, terminalTab, webTab } from "./types";
