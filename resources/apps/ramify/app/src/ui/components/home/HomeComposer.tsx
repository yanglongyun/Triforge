...
const HOME_COPY = {
  'zh-CN': {
    ...
    note: '由连接的 agent 宿主生成 · 每一版都会保留在树上',
    categories: [
  ...
  en: {
    ...
    note: 'Generated by the connected agent host · Every version stays on the tree',
    categories: [
        ...
        <section className="bd-ticket-top">
          ...
          <div className="bd-ticket-write">
            <textarea ref={promptRef} value={prompt} maxLength={MAX_PROMPT_LENGTH}
              onChange={(event) => onPromptChange(event.target.value)} placeholder={t('gen.createPlaceholder')}
              onKeyDown={(event) => {
        ...
        <section className="bd-ticket-bottom">
          <div className="bd-ticket-row">
            ...
            <button type="submit" className="bd-start" disabled={disabled}>
              ...
              {creating ? t('gen.sending') : copy.generate(count)}
            </button>
          </div>
        </section>
      </form>
