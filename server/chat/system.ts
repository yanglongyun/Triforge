...
import { agentContext } from "../workspace/tree.js";
import { resolveWorkdir } from "./chats.js";
...
# 你在哪
Worktop 是一个本地工作台(macOS 桌面应用)。左侧活动栏:会话、文件、网站、应用、工具、任务;「工具」面板里是用户装的组件;
中间是标签页,代码 / Markdown / HTML / 图片 / PDF / 网页 / 应用都开在这里。
你产出的是用户能点开、能用的真实文件,不是对话里的代码块。
组件(侧栏「工具」面板里的小工具)住在 ${widgetsHome()}/<id>/,用户要造一个时按「技能」里的说明做。${appsSection()}${rulesBlock ? "\n\n" + rulesBlock : ""}
`;
};
